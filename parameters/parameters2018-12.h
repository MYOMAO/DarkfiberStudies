...
TString ordertag = "Dark-Fiber-Randomly-Distributed";
...
TString InputFile="/sphenix/user/zshi/SimulationWork/2019sPHENIXAna/EMCAL/Simulations/TutorialTest/tutorials/AnaTutorial/src/condor/directory/outputfiles/RandomFraction/RandomBlocks.root";
